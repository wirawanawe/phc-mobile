...
const cleanAndSeed = async () => {
  try {
    ...
    console.log("🎉 All clinic data cleaned and reseeded successfully!");
  } catch (error) {
    console.error("❌ Error cleaning and seeding data:", error);
  } finally {
    await sequelize.close();
  }
};

// Run the clean and seed function
cleanAndSeed();
